...
// @homepage     https://github.com/tonakihan/RVP-player-OPlayer
// @source       https://raw.githubusercontent.com/tonakihan/RVP-player-OPlayer/refs/heads/releases/
...
const playerFunction = (video, stockPlayer) => {
    if (isBlobUrl(video.src)) {
        alert("Error! Found 'blob' source which not support the video player.");
        console.error("Error! Found 'blob' source which not support the video player.");
    }
